...
export const updateProductImageAction = async (prevState: any, formData: FormData) => {
  ...
  try {
    ...
    // Upload image and delete previous one from bucket
    const fullPath = await uploadImage(validatedFile.image);
...
export const toggleFavoriteAction = async (prevState: {
  ...
  try {
    ...
    return {message: favoriteId ? "removed from wishlist" : "added to wishlist"};
  } catch (error) {
    return renderError(error);
  }
};
...
// Set variable for product updates in cart items model
...
export const fetchOrCreateCart = async ({
  ...
  // Get cart from database(include cart items relation and individual product updated info)
...
export const updateCart = async (cart: Cart) => {
  ...
  // Define cart shipping if cartTotal has a value
...
export const addToCartAction = async (prevState: any, formData: FormData) => {
  ...
  try {
    ...
    // Fetch or create cart in order to add item
...
export const createOrderAction = async (prevState: any, formData: FormData) => {
  ...
  // Redirect to checkout page(params added)
